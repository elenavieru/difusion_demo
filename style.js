...
(function (blink) {
	...
	var difusion_demoStyle = function () {
			blink.theme.styles.basic.apply(this, arguments);
		},
		page = blink.currentPage;

	difusion_demoStyle.prototype = {
		bodyClassName: 'content_type_clase_difusion_demo',
		...
		formatCarouselindicators: function () {
			...
			$navbarBottom
				.attr('class', 'difusion_demo-navbar')
		...
		animateNavbarOnScroll: function () {
			...
			var $navbar = $('.difusion_demo-navbar');
			var lastScrollTop = 0;
	...
	difusion_demoStyle.prototype = _.extend({}, new blink.theme.styles.basic(), difusion_demoStyle.prototype);

	blink.theme.styles['difusion_demo'] = difusion_demoStyle;
